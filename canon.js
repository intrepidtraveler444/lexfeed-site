...
;(function (root, factory) {
  ...
  { id:'r20260630a', type:'curated', cat:'case-law', area:'Equity',
    title:'FHR European Ventures LLP v Cedar Capital Partners LLC [2014] UKSC 45',
    court:'UK Supreme Court',
    facts:'FHR paid Cedar Capital a broker\'s fee to introduce it to the sale of the Monte Carlo Grand Hotel. Unbeknown to FHR, Cedar had also secretly agreed with the vendor to receive a €10m commission on completion. FHR discovered this and sued to recover the commission, arguing it was held on constructive trust rather than subject only to a personal claim.',
    judgment:'The Supreme Court unanimously resolved the long-running debate between the proprietary and personal views of bribes and secret commissions. Lord Neuberger held that an agent who receives a bribe or secret commission in breach of fiduciary duty holds it on constructive trust for the principal. The earlier Court of Appeal decisions suggesting a personal remedy only were overruled.',
    ratio:'A bribe or secret commission received by an agent in breach of fiduciary duty is held on constructive trust for the principal; the principal therefore has a proprietary rather than merely a personal claim to the asset.',
    src:'BAILII', link:'https://www.bailii.org/uk/cases/UKSC/2014/45.html' },

  { id:'r20260630b', type:'curated', cat:'case-law', area:'Tort',
    title:'Various Claimants v Catholic Child Welfare Society [2012] UKSC 56',
    court:'UK Supreme Court',
    facts:'Brothers of the De La Salle Institute ran a residential school for boys and systematically sexually abused the pupils over many years. The question was whether the Institute — an unincorporated association — could be held vicariously liable for the Brothers\' torts, given that they were members of a religious order and not the Institute\'s employees in the ordinary sense.',
    judgment:'The Supreme Court held the Institute vicariously liable. Lord Phillips reformulated the governing test: the defendant need not be an employer in the strict sense; vicarious liability can extend to any relationship sufficiently analogous to employment, provided the tortious acts were committed in the course of activities integral to the defendant\'s enterprise and the defendant was in a position to control those activities and created the risk of harm.',
    ratio:'Vicarious liability extends beyond orthodox employment to relationships "akin to employment"; the key criteria are that the defendant created the risk of harm, the tortfeasor was integrated into the defendant\'s enterprise, and the defendant exercised control over the relevant activities.',
    src:'BAILII', link:'https://www.bailii.org/uk/cases/UKSC/2012/56.html' },

  { id:'r20260630c', type:'curated', cat:'case-law', area:'Contract',
    title:'Arnold v Britton [2015] UKSC 36',
    court:'UK Supreme Court',
    facts:'Holiday chalets were let on long leases providing for a service charge beginning at £90 per year and increasing by 10% compound annually for the duration of the 99-year term. As the arithmetic produced a charge exceeding £1 million per year by the end of the term, the lessees contended that the court should construe the clause as imposing a reasonable charge rather than the literal compound figure.',
    judgment:'The Supreme Court refused to depart from the natural meaning of the words. Lord Neuberger emphasised that courts must be careful not to let commercial common sense distort or overcome clear language, particularly where the contract was negotiated between experienced parties. Interpreting the clause as providing for a reasonable charge would rewrite a freely agreed bargain.',
    ratio:'Contract interpretation must respect clear and unambiguous language; commercial common sense and the avoidance of a harsh outcome cannot override the natural meaning of words, even where their literal application proves commercially disastrous for one party.',
    src:'BAILII', link:'https://www.bailii.org/uk/cases/UKSC/2015/36.html' },

  { id:'r20260630d', type:'curated', cat:'case-law', area:'Tort',
    title:'Coventry v Lawrence [2014] UKSC 13',
    court:'UK Supreme Court',
    facts:'The Lawrences bought a house near a motocross stadium and speedway track that had operated for many years under planning permission. They sued in private nuisance. The defendants argued that the planning permission authorised the activities and that they had acquired a prescriptive right to commit noise nuisance by 20 years\' uninterrupted use.',
    judgment:'The Supreme Court held that planning permission does not authorise private nuisance: it alters the public law planning character of an area but does not extinguish private law rights. However, it may be taken into account in assessing the character of the neighbourhood. A prescriptive right to commit a nuisance can in principle exist but requires proof of an actionable nuisance throughout the full 20-year period.',
    ratio:'Planning permission for an activity does not of itself confer a defence to a private nuisance claim; it may inform the character of the neighbourhood but private law rights are unaffected. A prescriptive right to commit a specific nuisance may be acquired by 20 years\' actionable interference.',
    src:'BAILII', link:'https://www.bailii.org/uk/cases/UKSC/2014/13.html' },

  { id:'r20260630e', type:'curated', cat:'case-law', area:'Tort',
    title:'Barker v Corus (UK) Plc [2006] UKHL 20',
    court:'House of Lords',
    facts:'Mr Barker worked for multiple employers and was also self-employed during part of his career, receiving asbestos exposure throughout. He developed mesothelioma. Under the Fairchild exception liability could be based on materially increasing the risk of the disease, but the House of Lords had to determine whether each defendant bore joint and several liability for the full loss or only proportionate liability.',
    judgment:'The House of Lords held that because the Fairchild exception is based on the wrongful creation of risk, each defendant\'s liability should be proportionate to its contribution to the risk of mesothelioma, not joint and several. Each was therefore only liable for its proportionate share of the damages. Parliament promptly reversed this for mesothelioma cases only by s.3 of the Compensation Act 2006, restoring joint and several liability in those cases.',
    ratio:'Under the Fairchild/McGhee exception for indeterminate causation, each defendant is liable in proportion to the risk of harm it contributed, not jointly and severally for the full loss. This was reversed for mesothelioma specifically by the Compensation Act 2006 s.3.',
    src:'BAILII', link:'https://www.bailii.org/uk/cases/UKHL/2006/20.html' },

  { id:'r20260630f', type:'curated', cat:'case-law', area:'Trusts',
    title:'Pitt v Holt; Futter v Futter [2013] UKSC 26',
    court:'UK Supreme Court',
    facts:'Two conjoined appeals concerned the Hastings-Bass rule and equitable rescission. In Pitt, a receiver invested personal injury compensation in a discretionary settlement without realising it would attract inheritance tax on the settlor\'s death. In Futter, trustees made distributions from a trust without realising they would trigger a tax charge on the beneficiaries. Both sets of claimants sought to set aside the transactions.',
    judgment:'The Supreme Court reformulated the Hastings-Bass rule: a trustee\'s exercise of a fiduciary power is voidable not merely because the trustee failed to consider relevant matters but only where that failure amounted to a breach of the trustee\'s duty. The Court also confirmed a general equitable jurisdiction to set aside a voluntary disposition — including a settlement by a competent adult — where there is a serious mistake of law or fact that was causative of the transaction.',
    ratio:'Under the reformulated Hastings-Bass rule, a trustee\'s exercise of a discretion is voidable only for breach of duty, not mere inadvertence; equity also has jurisdiction to rescind a voluntary disposition for a serious causative mistake of law or fact.',
    src:'BAILII', link:'https://www.bailii.org/uk/cases/UKSC/2013/26.html' },

  { id:'r20260630g', type:'curated', cat:'case-law', area:'Contract',
    title:'Morris-Garner v One Step (Support) Ltd [2018] UKSC 20',
    court:'UK Supreme Court',
    facts:'Two former directors of a supported housing company left to set up a competing business in breach of confidentiality and non-compete covenants. One Step sought "negotiating damages" — measured as the sum the defendants would notionally have had to pay to be released from the obligations — rather than conventional loss-based damages, because the real loss was difficult to quantify.',
    judgment:'The Supreme Court held that negotiating damages (formerly called Wrotham Park damages or gain-based damages) are a compensatory remedy, not a discretionary award of the defendant\'s gains. They are available where the breach involves the infringement of a right to control access to something — such as land, a trade secret, confidential information or other exclusionary rights — and ordinary compensatory damages would be an inadequate measure of the claimant\'s loss.',
    ratio:'Negotiating damages are compensatory and are measured as the price the claimant could reasonably have charged for releasing the defendant from the obligation; they are available where the breach infringes a right to control access to property, information or similar exclusionary rights, and conventional loss-based damages would be inadequate.',
    src:'BAILII', link:'https://www.bailii.org/uk/cases/UKSC/2018/20.html' },

  { id:'r20260630h', type:'curated', cat:'statute', area:'Criminal',
    title:'Proceeds of Crime Act 2002',
    body:"Created the comprehensive UK framework for recovering criminal proceeds through confiscation, civil recovery and taxation, and established the three core money-laundering offences together with the Suspicious Activity Report (SAR) regime. It replaced fragmented earlier legislation with a single statute and is the principal weapon of law enforcement in financial crime and anti-corruption work.",
    sections:[
      { num:'6', head:'Confiscation Orders', text:'Requires a Crown Court to make a confiscation order where a convicted defendant has benefited from criminal conduct, assessed by reference to the defendant\'s "benefit figure" and recoverable from available assets.' },
      { num:'327', head:'Concealing Criminal Property', text:'An offence of concealing, disguising, converting, transferring or removing criminal property from England and Wales, carrying a maximum of 14 years\' imprisonment.' },
      { num:'328', head:'Arrangements', text:'Makes it an offence to enter into or become concerned in an arrangement knowing or suspecting that it facilitates the acquisition, retention, use or control of criminal property by another.' },
      { num:'329', head:'Acquisition, Use and Possession', text:'An offence to acquire, use or possess criminal property, subject to defences for adequate consideration and acts done in the exercise of a function conferred by statute.' },
      { num:'330', head:'Failure to Disclose', text:'Persons in the regulated sector (banks, solicitors, accountants and others) must file a SAR where they know or suspect money laundering and the information came to them in the course of business.' },
